...
namespace AppoMobi.Maui.BLE
{
	public partial class Characteristic
	{
		...
		public Characteristic(BluetoothGattCharacteristic nativeCharacteristic, BluetoothGatt gatt, IGattCallback gattCallback, Maui.BLE.Service service) : this(service)
		{
		...
		{
			return Task.FromResult<IReadOnlyList<Maui.BLE.Descriptor>>(NativeCharacteristic.Descriptors.Select(item => new Maui.BLE.Descriptor(item, _gatt, _gattCallback, this)).Cast<Maui.BLE.Descriptor>().ToList());
		}
