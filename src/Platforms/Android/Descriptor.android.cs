...
namespace AppoMobi.Maui.BLE
{
	public partial class Descriptor
	{
		...
		public Descriptor(BluetoothGattDescriptor nativeDescriptor, BluetoothGatt gatt, IGattCallback gattCallback, Maui.BLE.Characteristic characteristic) : this(characteristic)
		{
