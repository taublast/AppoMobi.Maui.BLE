...
namespace AppoMobi.Maui.BLE
{
    ...
    public interface IAdapter
    {
        ...
        /// This means once per every <see cref="StartScanningForDevicesAsync(Guid[], Func&lt;Maui.BLE.Device, bool&gt;, CancellationToken)"/> call. 
        /// </summary>
        ...
        /// </summary>
        IReadOnlyList<Maui.BLE.Device> DiscoveredDevices { get; }

        /// <summary>
        /// List of currently connected devices.
        /// </summary>
        IReadOnlyList<Maui.BLE.Device> ConnectedDevices { get; }
        ...
        Task StartScanningForDevicesAsync(Guid[] serviceUuids = null, Func<Maui.BLE.Device, bool> deviceFilter = null, bool allowDuplicatesKey = false, CancellationToken cancellationToken = default);
        ...
        Task ConnectToDeviceAsync(Maui.BLE.Device device, ConnectParameters connectParameters = default, CancellationToken cancellationToken = default);
        ...
        Task DisconnectDeviceAsync(Maui.BLE.Device device);
        ...
        /// <param name="cancellationToken">The token to monitor for cancellation requests. The default value is None.</param>
        /// <returns></returns>
        Task<Maui.BLE.Device> ConnectToKnownDeviceAsync(Guid deviceGuid, ConnectParameters connectParameters = default, CancellationToken cancellationToken = default);
        ...
        IReadOnlyList<Maui.BLE.Device> GetSystemConnectedOrPairedDevices(Guid[] services = null);
    }
}
